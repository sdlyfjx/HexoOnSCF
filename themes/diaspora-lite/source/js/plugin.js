...
(function (c, e, f, b) {
    ...
    h.prototype.vendors = [null, ["-webkit-", "webkit"],
        ["-moz-", "Moz"],
        ["-o-", "O"],
        ["-ms-", "ms"]
    ];
...
(function e$$0(x, z, l) {
    ...
    1: [function (A, x, z) {
        if (!l) var l = {
            ...
            sum: function (h, g) {
                var l = {};
                return h.reduce(g ? function (h, b, a) {
                    l.index = a;
                    return h + g.call(l, b)
                } : function (h, b) {
                    return h + b
                ...
                if (c.count()) {
                    ...
                    if (e == d)
                        for (k = c.r1; k <= c.r2; k++) {
                            u = 0;
                            for (g = c.g1; g <= c.g2; g++)
                                for (t = c.b1; t <= c.b2; t++) p = h(k, g, t), u += a[p] || 0;
                            n += u;
                            y[k] = n
                        } else if (e == m)
                            for (k = c.g1; k <= c.g2; k++) {
                                u = 0;
                                for (g = c.r1; g <= c.r2; g++)
                                    for (t = c.b1; t <= c.b2; t++) p = h(g, k, t), u += a[p] || 0;
                                n += u;
                                y[k] = n
                            } else
                                for (k = c.b1; k <= c.b2; k++) {
                                    u = 0;
                                    for (g = c.r1; g <= c.r2; g++)
                                        for (t = c.g1; t <= c.g2; t++) p = h(g, t, k), u += a[p] || 0;
                                    n += u;
                                    y[k] = n
                                }
                    ...
                    if (!this._avg || a) {
                        ...
                        for (l = this.r1; l <= this.r2; l++)
                            for (s = this.g1; s <= this.g2; s++)
                                for (k = this.b1; k <= this.b2; k++) q = h(l, s, k), q = c[q] || 0, a += q, n += q * (l + 0.5) * b, e += q * (s + 0.5) * b, g += q * (k + 0.5) * b;
                ...
                nearest: function (a) {
                    for (var c = this.vboxes, b, n, d, e = 0; e < c.size(); e++)
                        if (n = Math.sqrt(Math.pow(a[0] - c.peek(e).color[0], 2) + Math.pow(a[1] -
                                c.peek(e).color[1], 2) + Math.pow(a[2] - c.peek(e).color[2], 2)), n < b || void 0 === b) b = n, d = c.peek(e).color;
                    return d
                },
                forcebw: function () {
                    var a = this.vboxes;
        ...
        (function () {
            ...
            window.CanvasImage = l = function () {
                function b(a) {
                    ...
                    if (a.videoHeight) {
                        this.width = this.canvas.width = a.videoWidth;
                        this.height = this.canvas.height = a.videoHeight;
                    } else {
